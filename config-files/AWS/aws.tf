...
variable "datacenter" {default = "aws-eu-west-1"}
...
variable "dns_subdomain" { default = ".demo" }
variable "dns_domain" { default = "aws.mrsmiggins.net" }
variable "dns_zone_id" { default = "Z14DS08R4LDOBI" }
